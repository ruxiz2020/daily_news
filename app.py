...
currency_pair_data = {
    "Dowjones": pd.read_csv(
        DATA_PATH.joinpath("Dowjones.csv"), index_col=1, parse_dates=["Date"]
    ),
    "Sp300": pd.read_csv(
        DATA_PATH.joinpath("Sp300.csv"), index_col=1, parse_dates=["Date"]
    ),
    "Temperature": pd.read_csv(
        DATA_PATH.joinpath("Temperature.csv"), index_col=1, parse_dates=["Date"]
    ),
    "Humidity": pd.read_csv(
        DATA_PATH.joinpath("Humidity.csv"), index_col=1, parse_dates=["Date"]
    ),
}
